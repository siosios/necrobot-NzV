...
namespace PoGo.NecroBot.Logic.State
{
    public class VersionCheckState : IState
    {
        public const string VersionUri =
            "https://rawgit.com/NzV/NecroBot/master/PoGo.NecroBot.Logic/Properties/AssemblyInfo.cs";

        public const string LatestReleaseApi =
            "https://api.github.com/repos/NzV/NecroBot/releases/latest";

        private const string LatestRelease =
            "https://github.com/NzV/NecroBot/releases";
